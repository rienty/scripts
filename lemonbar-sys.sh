...
while true; do
	echo -e "%{l} %{F-}%{B-}%{F#3c3836}%{B#ebdbb2}| $(print_desktop) |%{F-}%{B-}%{c}%{F#504549}%{B#689d6a}| $(print_date) $(print_time) |%{F-}%{B-}  %{r}%{F#3c3836}%{B#b8bb26}| $(print_bat)  $(print_mem)  $(print_cpuinfo) |%{F-}%{B-} "
sleep 1
done
exit 0
